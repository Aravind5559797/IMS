    ...
    public partial class newdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HistOrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistOrder", x => x.HistOrderId);
                    table.ForeignKey(
                        name: "FK_HistOrder_Order_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shop_PlatformId",
                table: "Shop",
                column: "PlatformId");

            migrationBuilder.CreateIndex(
                name: "IX_Shop_UserIdentifier",
                table: "Shop",
